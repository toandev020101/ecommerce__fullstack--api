...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], ProductImage.prototype, "productItemId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => ProductItem_1.ProductItem, (productItem) => productItem.productImages),
    (0, typeorm_1.JoinColumn)({ name: 'productItemId' }),
    __metadata("design:type", ProductItem_1.ProductItem)
], ProductImage.prototype, "productItem", void 0);
