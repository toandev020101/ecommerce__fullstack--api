...
router.get('/search', checkAuth_1.checkAuth, (0, checkPermission_1.checkPermission)('/category/search', 'get'), categoryController.getListBySearchTerm);
router.get('/public', categoryController.getAllPublic);
router.get('', checkAuth_1.checkAuth, (0, checkPermission_1.checkPermission)('/category', 'get'), categoryController.getAll);
...
router.put('/:id', checkAuth_1.checkAuth, (0, checkPermission_1.checkPermission)('/category/:id', 'put'), (0, validateYup_1.default)(categorySchema_1.default), categoryController.updateOne);
router.patch('/:id', checkAuth_1.checkAuth, (0, checkPermission_1.checkPermission)('/category/:id', 'patch'), (0, validateYup_1.default)(categorySchema_1.default), categoryController.updateOne);
...
//# sourceMappingURL=categoryRoute%20copy.js.map