...
router.get('', checkAuth_1.checkAuth, (0, checkPermission_1.checkPermission)('/coupon', 'get'), couponController.checkOne);
router.post('', checkAuth_1.checkAuth, (0, checkPermission_1.checkPermission)('/coupon', 'post'), (0, validateYup_1.default)(orderSchema_1.default), couponController.addOne);
