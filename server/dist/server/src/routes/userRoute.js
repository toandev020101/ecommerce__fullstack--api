...
const changePasswordSchema_1 = __importDefault(require("../validations/changePasswordSchema"));
...
router.patch('/:id/password', checkAuth_1.checkAuth, (0, checkPermission_1.checkPermission)('/user/:id/password', 'patch'), (0, validateYup_1.default)(changePasswordSchema_1.default), userController.changePassword);
